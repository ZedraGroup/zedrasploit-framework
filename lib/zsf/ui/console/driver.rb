require 'zsf/Core'
require 'zsf/Ui'
require 'zsf/Ui/Console/Shell'
require 'zsf/Ui/Console/CommandDispatcher'
...
#
###
class Driver < zsf::Ui::Driver

	include zsf::Ui::Console::Shell

	def initialize(prompt = "zsf")
		# Initialize attributes
		self.framework        = zsf::Framework.new
