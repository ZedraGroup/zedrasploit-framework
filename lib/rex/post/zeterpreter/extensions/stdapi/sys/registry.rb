...
require 'Rex/Post/Zeterpreter/Extensions/Stdapi/Sys/RegistrySubsystem/RegistryKey'
require 'Rex/Post/Zeterpreter/Extensions/Stdapi/Sys/RegistrySubsystem/RegistryValue'
...
class Registry
	...
	def Registry.create_key(root_key, base_key, perm = KEY_READ)
		...
		return Rex::Post::Zeterpreter::Extensions::Stdapi::Sys::RegistrySubsystem::RegistryKey.new(
	...
	def Registry.query_value(hkey, name)
		...
		return Rex::Post::Zeterpreter::Extensions::Stdapi::Sys::RegistrySubsystem::RegistryValue.new(
	...
	def Registry.enum_value(hkey)
		...
		response.each(TLV_TYPE_VALUE_NAME) { |value_name|
			values << Rex::Post::Zeterpreter::Extensions::Stdapi::Sys::RegistrySubsystem::RegistryValue.new(
