...
require 'Rex/Post/Zeterpreter/Channels/Pools/StreamPool'
...
require 'Rex/Post/Zeterpreter/Extensions/Stdapi/Sys/ProcessSubsystem/IO'
require 'Rex/Post/Zeterpreter/Extensions/Stdapi/Sys/ProcessSubsystem/Memory'
require 'Rex/Post/Zeterpreter/Extensions/Stdapi/Sys/ProcessSubsystem/Thread'
...
class Process < Rex::Post::Process
	...
	include Rex::Post::Zeterpreter::ObjectAliasesContainer
	...
	def Process.execute(path, arguments = nil, opts = nil)
		...
		if (channel_id != nil)
			channel = Rex::Post::Zeterpreter::Channels::Pools::StreamPool.new(client, 
		...
		initialize_aliases(
			{
				...
				'io'     => Rex::Post::Zeterpreter::Extensions::Stdapi::Sys::ProcessSubsystem::IO.new(self),
				'memory' => Rex::Post::Zeterpreter::Extensions::Stdapi::Sys::ProcessSubsystem::Memory.new(self),
				'thread' => Rex::Post::Zeterpreter::Extensions::Stdapi::Sys::ProcessSubsystem::Thread.new(self),
			})
	end
