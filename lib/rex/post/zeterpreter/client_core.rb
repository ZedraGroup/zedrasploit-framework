...
=end
	def use(module, opts)
		...
		if (load_library(
				'LibraryFilePath' => 'data/zeterpreter/ext_server_' + module.downcase + '.dll',
				'UploadLibrary'   => true,
				'Extension'       => true,
	...
	# Migrates the zeterpreter instance to the process specified
...
###           ###
		...
		zetsrv = "data/zeterpreter/zetsrv.dll"
		buf    = "zetsrv.dll\x00" + ::IO.readlines(zetsrv).join
		size   = buf.length
