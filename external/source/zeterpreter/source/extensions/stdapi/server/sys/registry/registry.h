#ifndef _ZETERPRETER_SOURCE_EXTENSION_STDAPI_STDAPI_SERVER_SYS_REGISTRY_REGISTRY_H
#define _ZETERPRETER_SOURCE_EXTENSION_STDAPI_STDAPI_SERVER_SYS_REGISTRY_REGISTRY_H
