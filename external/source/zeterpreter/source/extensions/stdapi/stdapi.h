#ifndef _ZETERPRETER_SOURCE_EXTENSION_STDAPI_STDAPI_H
#define _ZETERPRETER_SOURCE_EXTENSION_STDAPI_STDAPI_H

#include "../../common/common.h"

#ifdef ZETERPRETER_CLIENT_EXTENSION
	#include "../../client/zetcli.h"
#endif
...
#define TLV_TYPE_DIRECTORY_PATH        \
		MAKE_CUSTOM_TLV(                 \
				...
				TLV_TYPE_EXTENSION_STDAPI, \
				1200)
#define TLV_TYPE_FILE_NAME             \
		MAKE_CUSTOM_TLV(                 \
				TLV_META_TYPE_STRING,      \
				TLV_TYPE_EXTENSION_STDAPI, \
				1201)
#define TLV_TYPE_FILE_PATH             \
		MAKE_CUSTOM_TLV(                 \
				TLV_META_TYPE_STRING,      \
				TLV_TYPE_EXTENSION_STDAPI, \
				1202)
#define TLV_TYPE_FILE_MODE             \
		MAKE_CUSTOM_TLV(                 \
				TLV_META_TYPE_STRING,      \
				TLV_TYPE_EXTENSION_STDAPI, \
				1203)

#define TLV_TYPE_STAT_BUF              \
		MAKE_CUSTOM_TLV(                 \
