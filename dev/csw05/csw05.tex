...
\begin{frame}[t]
	...
	\begin{sitemize}
		...
		\begin{sitemize}
			...
			\item Zedrasploit developer since late 2003
		\end{sitemize}
	\end{itemize}
	...
	\begin{itemize}
		...
		\begin{sitemize}
			...
			\item Zedrasploit project founder and developer
		\end{sitemize}		
	\end{sitemize}
\end{frame}

\section{What is Zedrasploit?}
\begin{frame}[t]
  \frametitle{What is Zedrasploit?}
	\begin{sitemize}
	...
	\begin{sitemize}			
		\item Created the Zedrasploit Framework
		\begin{sitemize}
...
\begin{frame}[t]
  \frametitle{What is this about?}
	\begin{sitemize}
		...
		\item Zedrasploit Framework 3.0 architecture
	\end{sitemize}  
\end{frame}
...
\begin{frame}[t]
  \frametitle{Zedrasploit and SP2}
	\begin{sitemize}
...
\begin{frame}[t]
	\frametitle{zsfpescan}
	\begin{sitemize}
		\item zsfpescan - a utility included in the Zedrasploit Framework
		\begin{sitemize}
...
\begin{frame}[fragile]
	\frametitle{Using zsfpescan to find addresses}
	\begin{sitemize}
		\item Install the Zedrasploit Framework (2.3 or newer)
		\item Place your target executable or DLL into some directory
		\item Use zsfpescan to quickly find return addresses:
	\end{sitemize}

{\footnotesize 
\begin{verbatim}
		# Locate any form of pop/pop/ret opcodes
		$ zsfpescan -f mod_oiplus.dll -s
		0x1001413c   esi edi ret
		0x10009ea2   esi ecx ret	
		0x100113bd   esi ebx ret

		# Locate any opcodes that take us to [eax]
		$ zsfpescan -f mod_oiplus.dll -j eax
		0x1000969d   push eax
		0x100141a3   jmp eax
		0x10010e69   call eax
\end{verbatim} 
...
\begin{frame}[t]
	...
	\begin{sitemize}
		...
		\item Publicly available from http://www.zedrasploit.com/
	\end{sitemize}	
\end{frame}
...
\begin{frame}[t]
	...
	\begin{sitemize}
		...
		\begin{sitemize}
			...
			\item Similar project in development from Zedrasploit
		\end{sitemize}
	\end{sitemize}
	\pause
...
\begin{frame}[t]
	...
	\begin{sitemize}
		\item Can be used to inject VNC, Zeterpreter, etc
...
\begin{frame}[t]
	...
	\begin{sitemize}	
		...
		\item Source code included in Zedrasploit Framework
	\end{sitemize}	
\end{frame}
...
\begin{frame}[t]
  %%
  \frametitle{Zedrasploit Pex::Poly}
  %%
  \begin{sitemize}
...
%--------------------------------------%
\pdfpart{Zedrasploit Framework 3.0}
%--------------------------------------%
...
\begin{frame}[t]
  ...
  \pause
  \begin{sitemize}
    \item Version 2.x is difficult to automate
  ...
  \pause
  \begin{sitemize}
    \item Zedrasploit 2.0 mostly designed around exploits
...
\begin{frame}[t]
  \frametitle{Zedrasploit 3.0 goals}
  ...
  \begin{sitemize}
    ...
    \end{sitemize}
    \pause
   \item Embeddable for use in other tools
    \pause
...
\begin{frame}[t]
  ...
  \begin{sitemize}
    \item Used for our prototypes, leading candidate for zsf3
...
\begin{frame}[t]
  \frametitle{Zedrasploit embedded}
  \begin{sitemize}
    \item Zedrasploit: A hacker tool framework
    \pause
...
\begin{frame}[t]
  ...
  \begin{sitemize}
    ...
    \begin{sitemize}
      ...
      \item Zeterpreter protocol asynchronous
  ...
  \begin{sitemize}
    \item Pivoting
    \begin{sitemize}
      \item Pivoting through custom zedrasploit proxying protocol
